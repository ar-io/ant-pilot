  ...
  function calculateAuctionPriceForBlock({
    ...
    const dutchAuctionBid = startPrice * Math.pow(1 - decaySinceStart, scalingExponent);
    return new IOToken(
  ...
  function getAuctionPricesForInterval({
    ...
    const { auctionDuration, exponentialDecayRate, scalingExponent } = auctionSettings;
    const prices = {};
    for (let intervalBlockHeight = 0; intervalBlockHeight <= auctionDuration; intervalBlockHeight += blocksPerInterval) {
    ...
    if (!auction) {
      ...
      return {
        result: {
          ...
          currentPrice: auctionObject.floorPrice,
  ...
  var schema15 = { "$id": "#/definitions/joinNetwork", "type": "object", "properties": { "function": { "type": "string", "const": "joinNetwork" }, "qty": { "type": "number", "minimum": 1 }, "fqdn": { "type": "string", "pattern": "^(?:(?!-)[A-Za-z0-9-]{1,63}(?<!-)\\.)+[A-Za-z]{1,63}$" }, "port": { "type": "number", "minimum": 0, "maximum": 65535 }, "protocol": { "type": "string", "pattern": "^(http|https)$" }, "properties": { "type": "string", "pattern": "^[a-zA-Z0-9_-]{43}$" }, "note": { "type": "string", "pattern": "^.{1,256}$" }, "label": { "type": "string", "pattern": "^.{1,64}$" }, "observerWallet": { "type": "string", "pattern": "^(|[a-zA-Z0-9_-]{43})$" } }, "required": ["function", "qty", "fqdn", "port", "protocol", "properties", "note", "label"], "additionalProperties": false };
  var func2 = Object.prototype.hasOwnProperty;
  var pattern9 = new RegExp("^(?:(?!-)[A-Za-z0-9-]{1,63}(?<!-)\\.)+[A-Za-z]{1,63}$", "u");
  ...
  function validate14(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.function === void 0) {
        const err0 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "function" }, message: "must have required property 'function'" };
        if (vErrors === null) {
          vErrors = [err0];
        } else {
          vErrors.push(err0);
      ...
      if (data.fqdn === void 0) {
        const err2 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "fqdn" }, message: "must have required property 'fqdn'" };
        if (vErrors === null) {
          vErrors = [err2];
        } else {
          vErrors.push(err2);
      ...
      if (data.protocol === void 0) {
        const err4 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "protocol" }, message: "must have required property 'protocol'" };
        if (vErrors === null) {
          vErrors = [err4];
        } else {
          vErrors.push(err4);
      ...
      if (data.properties === void 0) {
        const err5 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "properties" }, message: "must have required property 'properties'" };
        if (vErrors === null) {
          vErrors = [err5];
        } else {
          vErrors.push(err5);
      ...
      if (data.label === void 0) {
        const err7 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "label" }, message: "must have required property 'label'" };
        if (vErrors === null) {
          vErrors = [err7];
        } else {
          vErrors.push(err7);
      ...
      if (data.function !== void 0) {
        let data0 = data.function;
        if (typeof data0 !== "string") {
          const err9 = { instancePath: instancePath + "/function", schemaPath: "#/properties/function/type", keyword: "type", params: { type: "string" }, message: "must be string" };
          if (vErrors === null) {
            vErrors = [err9];
          } else {
            vErrors.push(err9);
        ...
        if ("joinNetwork" !== data0) {
          const err10 = { instancePath: instancePath + "/function", schemaPath: "#/properties/function/const", keyword: "const", params: { allowedValue: "joinNetwork" }, message: "must be equal to constant" };
          if (vErrors === null) {
            vErrors = [err10];
          } else {
            vErrors.push(err10);
      ...
      if (data.qty !== void 0) {
        ...
        if (typeof data1 == "number" && isFinite(data1)) {
          if (data1 < 1 || isNaN(data1)) {
            const err11 = { instancePath: instancePath + "/qty", schemaPath: "#/properties/qty/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1" };
            if (vErrors === null) {
              vErrors = [err11];
            } else {
              vErrors.push(err11);
      ...
      if (data.fqdn !== void 0) {
        ...
        if (typeof data2 === "string") {
          if (!pattern9.test(data2)) {
            const err13 = { instancePath: instancePath + "/fqdn", schemaPath: "#/properties/fqdn/pattern", keyword: "pattern", params: { pattern: "^(?:(?!-)[A-Za-z0-9-]{1,63}(?<!-)\\.)+[A-Za-z]{1,63}$" }, message: 'must match pattern "^(?:(?!-)[A-Za-z0-9-]{1,63}(?<!-)\\.)+[A-Za-z]{1,63}$"' };
            if (vErrors === null) {
              vErrors = [err13];
            } else {
              vErrors.push(err13);
          ...
          const err14 = { instancePath: instancePath + "/fqdn", schemaPath: "#/properties/fqdn/type", keyword: "type", params: { type: "string" }, message: "must be string" };
          if (vErrors === null) {
            vErrors = [err14];
          } else {
            vErrors.push(err14);
